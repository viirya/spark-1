...
class SparkQlSuite extends PlanTest {
  ...
  test("alter table") {
    ...
    // Alter Table skewed
    parser.parsePlan("ALTER TABLE table_name SKEWED BY (dt, country) ON (('2008-08-08', 'us'), ('2009-09-09', 'uk')) STORED AS DIRECTORIES")
    parser.parsePlan("ALTER TABLE table_name SKEWED BY (dt, country) ON ('2008-08-08', 'us') STORED AS DIRECTORIES")
    parser.parsePlan("ALTER TABLE table_name SKEWED BY (dt, country) ON (('2008-08-08', 'us'), ('2009-09-09', 'uk'))")
       
    // Alter Table skewed location
    parser.parsePlan("ALTER TABLE table_name SET SKEWED LOCATION ('123'='location1', 'test'='location2')")
    parser.parsePlan("ALTER TABLE table_name SET SKEWED LOCATION (('2008-08-08', 'us')='location1', 'test'='location2')")

    // Alter Table add partition
    parser.parsePlan("ALTER TABLE table_name ADD IF NOT EXISTS PARTITION (dt='2008-08-08', country='us') LOCATION 'location1' PARTITION (dt='2009-09-09', country='uk')")

    // Alter Table rename partition
    parser.parsePlan("ALTER TABLE table_name PARTITION (dt='2008-08-08', country='us') RENAME TO PARTITION (dt='2008-09-09', country='uk')")

    // Alter Table exchange partition
    parser.parsePlan("ALTER TABLE table_name_1 EXCHANGE PARTITION (dt='2008-08-08', country='us') WITH TABLE table_name_2")

    // Alter Table drop partitions
    parser.parsePlan("ALTER TABLE table_name DROP IF EXISTS PARTITION (dt='2008-08-08', country='us'), PARTITION (dt='2009-09-09', country='uk')") 
    parser.parsePlan("ALTER TABLE table_name DROP IF EXISTS PARTITION (dt='2008-08-08', country='us'), PARTITION (dt='2009-09-09', country='uk') PURGE FOR METADATA REPLICATION ('test')") 
    ...
    parser.parsePlan("ALTER TABLE table_name SET FILEFORMAT INPUTFORMAT 'test' OUTPUTFORMAT 'test' SERDE 'test' INPUTDRIVER 'test' OUTPUTDRIVER 'test'")
    parser.parsePlan("ALTER TABLE table_name SET FILEFORMAT INPUTFORMAT 'test' OUTPUTFORMAT 'test' SERDE 'test'")
    parser.parsePlan("ALTER TABLE table_name PARTITION (dt='2008-08-08', country='us') SET FILEFORMAT PARQUET")

    // Alter Table set location
    parser.parsePlan("ALTER TABLE table_name SET LOCATION 'new location'")
    parser.parsePlan("ALTER TABLE table_name PARTITION (dt='2008-08-08', country='us') SET LOCATION 'new location'")
    ...
    parser.parsePlan("ALTER TABLE table_name PARTITION (dt='2008-08-08', country='us') COMPACT 'MAJOR'")
    ...
    parser.parsePlan("ALTER TABLE table_name CHANGE col_old_name col_new_name column_type")
 
    parser.parsePlan("ALTER TABLE table_name CHANGE COLUMN col_old_name col_new_name column_type COMMENT col_comment FIRST column_name CASCADE")
